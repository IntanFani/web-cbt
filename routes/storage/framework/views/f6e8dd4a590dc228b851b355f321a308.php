...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Aplikasi CBT Sekolah'); ?></title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav flex-column mt-3">
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->routeIs('dashboard.guru') ? 'active' : ''); ?>" href="<?php echo e(route('dashboard.guru')); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->routeIs('ujian.*') ? 'active' : ''); ?>" href="<?php echo e(route('dashboard.guru')); ?>"> 
    ...
    <div class="main-content">
        ...
        <div class="top-navbar d-flex justify-content-between align-items-center">
            <h5 class="m-0 fw-bold text-secondary"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h5>
            <div class="d-flex align-items-center">
                <div class="me-3 text-end">
                    <small class="d-block text-muted">Login sebagai Guru</small>
                    <span class="fw-bold"><?php echo e(Auth::user()->name); ?></span>
                </div>
                <img src="https://ui-avatars.com/api/?name=<?php echo e(Auth::user()->name); ?>&background=0D8ABC&color=fff" class="rounded-circle" width="40">
            </div>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\web-cbt\resources\views/layouts/app.blade.php ENDPATH**/ ?>