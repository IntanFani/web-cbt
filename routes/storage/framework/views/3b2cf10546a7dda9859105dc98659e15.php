            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    <li class="nav-item me-3">
                        <span class="text-white small">Halo, <strong><?php echo e(Auth::user()->name); ?></strong></span>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container py-5">
        ...
        <?php if(session('success')): ?>
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <i class="fas fa-trophy me-2"></i> <?php echo e(session('success')); ?>
                    ...
                    <div class="card h-100 border-0 shadow-sm hover-shadow">
                        <div class="card-body position-relative">
                            <span class="position-absolute top-0 end-0 badge bg-light text-dark m-3 border">
                                <i class="fas fa-clock me-1"></i> <?php echo e($exam->duration); ?> Menit
                            </span>
                            ...
                            <h5 class="card-title fw-bold text-dark"><?php echo e($exam->title); ?></h5>

                            <p class="card-text text-muted small mb-4">
                                <i class="fas fa-user-tie me-1"></i> Guru: <?php echo e($exam->teacher->name ?? 'Admin'); ?>
                            ...
                            <div class="d-grid">
                                <?php if($status == 'belum_mulai'): ?>
                                    <a href="<?php echo e(route('ujian.start', $exam->id)); ?>" class="btn btn-primary fw-bold">
                                        Kerjakan Sekarang <i class="fas fa-arrow-right ms-2"></i>
                                    </a>
                                <?php elseif($status == 'ongoing'): ?>
                                    <a href="<?php echo e(route('ujian.show', $exam->id)); ?>"
                                        class="btn btn-warning fw-bold text-dark">
                                        <i class="fas fa-history me-2"></i> Lanjutkan Ujian
                                    </a>
                                <?php elseif($status == 'completed' || $status == 'finished'): ?>
                                    <button class="btn btn-secondary" disabled>
                                        <i class="fas fa-check-circle me-2"></i> Sudah Selesai
                                    </button>
                                    <div class="text-center mt-2">
                                        <small class="text-success fw-bold">Nilai: <?php echo e($session->score ?? 0); ?></small>
                                    </div>
                                <?php endif; ?>
                            </div>
...
<?php /**PATH C:\xampp\htdocs\web-cbt\resources\views/dashboard/siswa/index.blade.php ENDPATH**/ ?>